...
if(nrow(rearrangement) > 0) {
  kable(rearrangement, "latex",  linesep = "", booktabs = T, caption = "Rearrangement Summary Table") %>%
    kable_styling(latex_options = c("hold_position", "scale_down"))
} else {
...
ggplot(gene.dist, aes(y = description)) +
  ...
  scale_x_continuous(labels = scales::label_percent(accuracy = .1, scale = 1), 
                     limits = c(0, 100)) +
  geom_vline(linetype = "dashed", aes(xintercept = dash[[1]], color = "random exon")) +
